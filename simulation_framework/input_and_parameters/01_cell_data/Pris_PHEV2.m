...
BatPara.cell_type = 'Pris';     % Select either 'Pouch', 'Pris' or 'Cyl'
...
t_cell_capacity = 43.4;   % Cell capacigy C_A  in Ah
...
BatPara.physical.dim_x = 26.5e-3;   % Cell dimension in x-direction
BatPara.physical.dim_y = 148e-3;    % Cell dimension in y-direction
BatPara.physical.dim_z = 91e-3;     % Cell dimension in z-direction
